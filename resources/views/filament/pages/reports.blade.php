<x-filament-panels::page>
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                type="date"
                                wire:model.live="dateRange.from"
    ...
    <div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
        @php
            ...
            $chartWidgets = array_slice($footerWidgets, 0, 2); // IncomeChart y StatusChart
        @endphp
    ...
    <div>
        @php
            $tableWidget = end($footerWidgets); // ReportHistoryTableWidget
        @endphp
